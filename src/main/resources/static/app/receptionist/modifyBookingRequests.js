        ...
        requests.forEach((request) => {
          ...
          requestDiv.innerHTML = `
            ...
            <div class="text-gray-600 mb-4">
              ...
              <p><strong>Old Start Date:</strong> ${request.oldStartDate}</p>
              <p><strong>Old End Date:</strong> ${request.oldEndDate}</p>
            </div>
            <div class="bg-gray-100 p-4 rounded-lg mb-4">
              <h3 class="text-lg font-semibold text-gray-800 mb-2">Requested Changes:</h3>
              <ul class="text-gray-600">
                <li><strong>New Start Date:</strong> ${request.startDate}</li>
                <li><strong>New End Date:</strong> ${request.endDate}</li>
              </ul>
            </div>
...
async function manageRequestModifyBooking(idBooking, approved) {
  ...
  try {
      const response = await fetch(`/api/hotelManagementSystem/manageRequestModifyBooking?${queryStringParameters}`, {
        method: 'POST',
      });
